...
@threestudio.register("lods-gs-system")
class GaussianDreamer(BaseLift3DSystem):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = loss + guidance_out['loss_embedding'] * self.C(self.cfg.loss['lambda_embedding'])
    ...
    def on_before_optimizer_step(self, optimizer):
        ...
        with torch.no_grad():
            ...
            if self.true_global_step < 1000: # 15000
                ...
                if self.true_global_step > 300 and self.true_global_step % 100 == 0: # 300 100
                    size_threshold = 20 if self.true_global_step > 300 else None # 3000
                    self.gaussian.densify_and_prune(0.0002 , 0.005, self.cameras_extent, size_threshold)
