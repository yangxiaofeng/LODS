...
@threestudio.register("lods-lora-guidance")
class StableDiffusionLODSGuidance(BaseModule):
    @dataclass
    class Config(BaseModule.Config):
        pretrained_model_name_or_path: str = "stabilityai/stable-diffusion-2-1-base"
        pretrained_model_name_or_path_lora: str = "stabilityai/stable-diffusion-2-1-base"
    ...
    def train_lora(
        ...
        noise_pred = self.forward_unet(
            ...
            noisy_latents,
            t,
            encoder_hidden_states=text_embeddings_uncond.repeat(
    ...
    def forward(
        ...
        **kwargs,
        ...
        loss_lora = self.train_lora(latents, text_embeddings_vd, camera_condition)
        return {
            "loss_sds": loss_sds,
            "loss_lora": loss_lora,
            "grad_norm": grad.norm(),
